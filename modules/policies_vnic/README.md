...
| <a name="input_ip_lease_moid"></a> [ip\_lease\_moid](#input\_ip\_lease\_moid) | A reference to a ippoolIpLease resource. | `list(map(string))` | `[]` | no |
| <a name="input_iscsi_boot_policy_moid"></a> [iscsi\_boot\_policy\_moid](#input\_iscsi\_boot\_policy\_moid) | A reference to a vnicIscsiBootPolicy resource. | `list(map(string))` | `[]` | no |
...
| <a name="input_mac_lease_moid"></a> [mac\_lease\_moid](#input\_mac\_lease\_moid) | A reference to a macpoolLease resource. | `list(map(string))` | `[]` | no |
| <a name="input_mac_pool_moid"></a> [mac\_pool\_moid](#input\_mac\_pool\_moid) | A reference to a macpoolPool resource. | `list(map(string))` | `[]` | no |
...
| <a name="input_sp_nics_moid"></a> [sp\_nics\_moid](#input\_sp\_nics\_moid) | An array of relationships to vnicEthIf resources. | `list(map(string))` | `[]` | no |
...
| <a name="input_vmq_adapter_policy_moid"></a> [vmq\_adapter\_policy\_moid](#input\_vmq\_adapter\_policy\_moid) | Ethernet Adapter policy to be associated with the Sub vNICs. The Transmit Queue and Receive Queue resource value of VMMQ adapter policy should be greater than or equal to the configured number of sub vNICs. | `string` | n/a | yes |
...
| <a name="input_vnic_network_moid"></a> [vnic\_network\_moid](#input\_vnic\_network\_moid) | A reference to a vnicEthNetworkPolicy resource. | `string` | n/a | yes |
