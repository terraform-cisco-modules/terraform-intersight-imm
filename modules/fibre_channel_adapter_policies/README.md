...
| <a name="input_flogi_retries"></a> [flogi\_retries](#input\_flogi\_retries) | he number of times that the system tries to log in to the fabric after the first failure.  A Value greater than 0. | `number` | `8` | no |
