# firmware_switch - Intersight Infrastructure Firmware Upgrade Terraform Module

## Usage

```hcl
module "upgrade_switch" {

  source = "terraform-cisco-modules/imm/intersight//modules/firmware_switch"
...
* [switch_upgrade](https://registry.terraform.io/providers/CiscoDevNet/intersight/latest/docs/resources/firmware_switch_upgrade)
