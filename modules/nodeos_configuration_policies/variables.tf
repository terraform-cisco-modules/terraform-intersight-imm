...
#
# Kubernetes Node OS Configuration Policy Variables Section.
#____________________________________________________________
...
variable "ntp_servers" {
  ...
  description = "NTP Servers for the Kubernetes Node OS Configuration Policy."
  type        = list(string)
}
